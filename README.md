...
**更新1.1.3版** 本轮投票结束，但个人榜可以继续玩；个人榜可选得分/胜率排名，并支持导入导出；支持https 

#### 非常非常抱歉，由于操作服务器失误，46万-65万条数据丢失了，对不起各位，以后维护一定更加谨慎！！

前端JS，后端Python Flask，数据全部来自网友投票，仅供娱乐，准确度可能很低，求轻喷。有好点子欢迎直接提issue或者Pull requests！

（我本来想拿React重写一遍前端的，[学了一点](https://syadda.github.io/)，太难了学不会，所以咕了）

（这次起初租的阿里云的新加坡服务器，但似乎访问有点难，最后又换成广东的服务器）

## 直接访问：六星干员强度投票箱 [https://6starvote.me](https://6starvote.me)
